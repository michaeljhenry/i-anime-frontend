...
const NavLinks = (props) => {
    ...
    navs = (
      <React.Fragment>
        <ul className="nav-links">
          ...
          <li>
            <NavLink activeClassName="is-active" to="/anime/add">
              Add
            </NavLink>
          </li>
          <li>
            <NavLink activeClassName="is-active" to={`/${auth.userId}/animes`}>
              My Anime
            </NavLink>
          </li>
        </ul>
    ...
    navs = (
      <React.Fragment>
        <ul className="nav-links">
          ...
          <li>
            <NavLink activeClassName="is-active" to={`/auth`}>
              Login/Signup
            </NavLink>
          </li>
        </ul>
  ...
  return (
    <React.Fragment>
      {sideDrawer && (
        <React.Fragment>
          <Backdrop colour="dark" onClick={closeDrawer} />
          <SideDrawer show={sideDrawer}>
            <nav className="sidebar-nav">{sideDrawerInnerNavs}</nav>
          </SideDrawer>
        </React.Fragment>
      )}
      {!sideDrawer && (
